...
$sql1 = oci_parse($connect,"SELECT * FROM account");
oci_execute($sql1);
$dyn_table1 ='<tr>';
...
*/
						...
						$sql2 = oci_parse($connect,"SELECT * FROM product ORDER BY quantity_sold DESC LIMIT 3");
						oci_ececute($sql2);
						$dyn_table2 ='<tr>';
...
<title>BAZZINGA | User database</title>
	...
	<div id="templatemo_header">
      ...
      <div id="header_right">
       ...
       <label style="font-size:36px" style="font-style:italic">
          ...
          <a href="admin_acc.php" >My Account</a> | <a href="popularproducts.php">Popular products</a> | <a href="queries.php">queries</a> | <a href="user_db.php" class="selected">user database</a> | <a href="logout.php">Sign out</a> </p>
