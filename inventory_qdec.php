...
$sql1 = mysql_query("SELECT * FROM product ORDER BY Quantity DESC",$connect);
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="inventory_qdec.php" class="selected">Quantity decreasing</a></li>
     ...
     <td>&nbsp;</td>
      ...
      <td>&nbsp;</td>
        ...
        <div style="float:right; width: 215px; margin-top: 20px;">
					...
					<p><a href="addproducts.php"><strong>Add MORE Products</strong></a></p>
