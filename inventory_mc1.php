...
$sql1 = mysql_query("SELECT * FROM product",$connect);
...
$sql3 = mysql_query("SELECT * FROM product",$connect);
...
While($row = mysql_fetch_assoc($sql3)){
	...
	{	
		$dyn_table3 .='<tr>';
		$dyn_table3 .='<td><a href="inventory_mc.php?$mc1='.$mc1.'">=>'.$mc1.'</a></td><br>';
		$dyn_table3 .='</tr>';
	}
	$i++;
...
<input type="submit" value="search" />
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="inventory_mc1.php" class="selected">Manufacturing Company</a>
                        <ul>
                        <li ><a href=""><?php echo $dyn_table3;?></a></li>
                        </ul>
                        </li>
  ...
  <table width="675" border="0" cellpadding="6">
    <tr bgcolor="#ddd">
      ...
      <td width="11%"><strong>Mfg company</strong></td>
