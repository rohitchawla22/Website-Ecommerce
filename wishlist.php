...
if(isset ($_POST['Prodid'])) {
	...
	header("location: wishlist.php"); //this is used to prevent reposting of products and quantities on refreshing
	exit();
...
if(!isset($_SESSION["cart_array"])||count($_SESSION["cart_array"])<1) {
	...
	foreach($_SESSION["cart_array"]as $each_item){
		...
		$sql=mysql_query("SELECT * FROM product WHERE Prodid='$item_id' LIMIT 1");
		...
		$cartOutput .='<td><form action="cart.php" method="post"><input name="Prodid'.$pd.'" type="submit"  value="Add to cart"/><input name="Prodid" type="hidden" value="'.$pd.'"/></form></td>';
		
		$cartOutput .='<td><form action="wishlist.php" method="post"><input name="deleteBtn '.$pd.'" type="submit"  value="X"/><input name="index_to_remove" type="hidden" value="'.$pd.'"/></form></td>';
		$cartOutput .="</tr>";
		$i++;
...
$dyn_table1 ='<tr>';
While($j<3 && $row = mysql_fetch_assoc($sql1)){
	$Name1 = $row["Name"];
	$Type1 = $row["Type"];
	...
	{	
		...
		$dyn_table1 .='<img src="images/templatemo_addtocart.png"></td></p><p>&nbsp;</p>';
	}
	$j++;
	...
	<div id="templatemo_header">
      ...
      <div id="header_right">
        ...
        <?php
          ...
          <a href="myaccount.php">My Account</a> | <a href="wishlist.php">My Wishlist</a> | <a href="cart.php">My Cart</a> | <a href="checkout.php">Checkout</a> | <a href="logout.php">Logout</a>  | <a href="admin.php"> Admin </a></p>
...
<input type="submit" value="search" class="sub_btn"/>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li class="last"><a href="dynamicproduct.php?type=Softwares">Softwares</a></li>
                    </ul>
                </div>
            </div>
            <div class="sidebar_box"><span class="bottom"></span>
  ...
  <table width="675" border="0" cellpadding="6">
    <tr bgcolor="#ddd">
      ...
      <td width="7%"><strong>Add to cart</strong></td>
     ...
     <td>&nbsp;</td>
      ...
      <td>&nbsp;</td>
        ...
        <div style="float:right; width: 215px; margin-top: 20px;">
		  ...
		  <p><a href="cart.php">Proceed to cart</a></p>
       ...
       <a href="wishlist.php?cmd=emptycart">Click Here to Empty Your Wishlist</a></p>
       </div>
     <br/>
     </div>
     <?php }
