...
$sql1 = mysql_query("SELECT * FROM product ORDER BY Prodid DESC",$connect);
...
<div id="templatemo_wrapper">
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="inventory_iddec.php"class="selected">Id Decreasing</a></li>
  ...
  <table width="675" border="0" cellpadding="6">
    ...
    <div id="templatemo_footer">
    	...
    	Copyright © 2013 <a href="#">chnaged BAZZINGA</a> 
         <div class="pins">
