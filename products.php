...
<title>changed BAZZINGA | Products</title>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
						...
						//mysql_select_db($database_connect, $connect);
						$connect1 = oci_connect($username_connect, $password_connect, $database_connect);
						$sql2 = oci_parse($connect1,"SELECT * FROM product ORDER BY qtysold DESC LIMIT 12");
						oci_execute($sql2)						
						$dyn_table2 ='<tr>';
...
$connect1 = oci_connect($username_connect, $password_connect, $database_connect);
$m = "shoes";
$sql = oci_parse($connect1,"SELECT * FROM product ORDER BY Prodid ");
oci_execute($sql);
...
*/
		...
		$dyn_table .='<td><p style="color:#000">'.$Name.'</p>';
		$dyn_table .='<br>'.$Type.'<br>';
		$dyn_table .='<a href="productdetail.php?Prodid='.$Prodid.'"><img src="'.$image.'" width = 200, height = 200/></a>';
		$dyn_table.='<br><center><p style="color:#000">Price: Rs.'.$price.'</p><br>';
