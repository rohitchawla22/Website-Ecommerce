    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="products.html">Men's Products</a>
                    <ul>
                ...
                <li><a href="products.html">Women's Products</a>
                	<ul>
                    	<li><a href="shirts.html">Shirts</a></li>
                        <li><a href="T-shirts.html">T-Shirts</a></li>
                        <li><a href="Trousers.html">Party Dresses</a></li>
                        <li><a href="Jeans.html">Jeans</a></li>
    ...
    <div id="templatemo_main">
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="#">TravelBags</a></li>
                        <li><a href="#">Sportswear</a></li>
                        <li><a href="#">Sheets</a></li>
                        <li><a href="#">Tiles</a></li>
                        <li><a href="#">gadgets</a></li>
                        <li class="last"><a href="#">Accessories</a></li>
                    </ul>
                </div>
            </div>
            <div class="sidebar_box"><span class="bottom"></span>
        ...
        <div id="content" class="float_r">
            ...
            <div class="product_box">
	            <h3>Paulo Bland</h3>
            	<a href="productdetail.html"><img src="images/gallery/shirt1.jpg"  width="200" height="200" alt="Shirt 1" /></a>
                <p> read more.</p>
            ...
            <div class="product_box">
            	...
            	<a href="productdetail.html"><img src="images/gallery/wshirt1.jpg" width="200" height="200" alt="Shirt 2" /></a>
                <p>data.</p>
            ...
            <div class="product_box no_margin_right">
            	<h3>Reed & Taylor</h3>
            	<a href="productdetail.html"><img src="images/gallery/shirt2.jpg" width="200" height="200" alt="Shoes 3" /></a>
                <p>data.</p>
            ...
            <div class="product_box">
            	<h3>Entise Casual</h3>
            	<a href="productdetail.html"><img src="images/gallery/wshirt2.jpg" width="200" height="200" alt="Shirt 4" /></a>
                <p>data.</p>
            ...
            <div class="product_box">
	            <h3>Ginny & Johnny</h3>
            	<a href="productdetail.html"><img src="images/gallery/shirt3.jpg" width="200" height="200" alt="Shirt 5" /></a>
                <p>data.</p>
            ...
            <div class="product_box no_margin_right">
            	<h3>Shirt</h3>
            	<a href="productdetail.html"><img src="images/gallery/w-shirt3.jpg" width="200" height="200" alt="Shirt 6" /></a>
                <p>data.</p>
            ...
            <div class="product_box">
            	<h3>shirt</h3>
            	<a href="productdetail.html"><img src="images/gallery/Shirt4.jpg" width="200" height="200" alt="Shirt 7" /></a>
				<p>data.</p>
            ...
            <div class="product_box">
            	<h3>shirt</h3>
            	<a href="productdetail.html"><img src="images/gallery/w-shirt4.jpg" width="200" height="200" alt="Shirt 8" /></a>
                <p>data.</p>
            ...
            <div class="product_box no_margin_right">
            	 <h3>shirt</h3>
            	<a href="productdetail.html"><img src="images/gallery/shirt5.jpg" width="200" height="200" alt="Shirt 9" /></a>
               	<p>data.</p>
        ...
        <div class="cleaner"></div>
        <button align="centre">
        <submit><a href="#">Next Page>></a></submit>
        </button>
