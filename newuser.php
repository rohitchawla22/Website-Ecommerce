...
$sql1 = oci_parse($connect1,"SELECT * FROM account ORDER BY userid ASC");
oci_execute($sql1);
...
<?php
					...
					$connect1 = oci_connect($username_connect, $password_connect, $database_connect);
						...
						$sql2 = oci_parse($connect1,"SELECT * FROM product ORDER BY quantity_sold DESC LIMIT 3");
						oci_execute($sql2);
						$dyn_table2 ='<tr>';
...
<title>Changed BAZZINGA| NEW USER DB</title>
