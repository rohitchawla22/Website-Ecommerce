...
$sql1 = mysql_query("SELECT * FROM product ORDER BY Quantity ASC",$connect);
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content"> 
                	<ul class="sidebar_list">
                        ...
                        <li><a href="inventory_qinc.php" class="selected" >Quantity increasing</a></li>
     ...
     <td>&nbsp;</td>
      ...
      <td>&nbsp;</td>
        ...
        <div style="float:right; width: 215px; margin-top: 20px;">
					...
					<p><a href="addproducts.php" class="h10">Add Products</a></p>
